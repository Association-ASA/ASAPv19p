...
QUERY:C277([PersonnesDevis:30]; [PersonnesDevis:30]Caduc:7#"Caduc@"; *)
QUERY:C277([PersonnesDevis:30];  & [PersonnesDevis:30]AnneeDevis:5=Year of:C25(Current date:C33); *)
...
For ($Salé; 1; $FT)
	$UUIDLabo:=$TbDevisOK{$Salé}
	$NumLabo:=ASAPTrouveNumeroLaboParUUID($UUIDLabo)
	APPEND TO ARRAY:C911(TbDevisOK; Num:C11($NumLabo))
End for 
