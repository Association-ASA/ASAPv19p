...
$MethodesLapîn:="Facturer le RAEMA Poudre:ASAPFactureRAEMAPoudre;Facturer le RAEMA Gel:ASAPFactureRAEMAGel;-:;Envoyer un courriel:ASAPEnvoiCourrielLabo;Test disponibilité factures:ASAPTestDispoFactureClient;"
$MethodesLapîn:=$MethodesLapîn+"Sélectionner les non payées:ASAPFactureNonPaye;Export EBP:ASAPExportFactureVersCompta;-:;Bilan des impayés:ASAPFactureBilanImpayés"
