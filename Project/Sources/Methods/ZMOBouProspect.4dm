...
If (Macintosh command down:C546)
	...
	$MéthodeAvant:="ASAPSurChargementSaisieProspect"
Else 
	QUERY:C277([Personnes:12]; [Personnes:12]TypePersonne:5="Prospect"; *)
	QUERY:C277([Personnes:12];  & [Personnes:12]Caduc:8=False:C215)
	$MéthodeAvant:="ASAPSurChargementSaisieProspect"
End if 
$Chemin:="Images/Buttons/BouProspect.png"
