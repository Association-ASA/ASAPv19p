	...
	If (TbProforma{$Salé}#"")  //& (<>TbPAAssociation{$L}#"LRAR-M")
		...
		Case of 
			...
			: (<>TbLotoBoiteIsotherme{$LP}>0) & ((<>TbLotoNbColisPoudreSR{$LP}+<>TbLotoNbColisPoudreAR{$LP})=0)  // si isotherme  = 8 Kg     386 mm x 286 mm x 297 mm
				$Poids:="8 Kg"
				$Dimensions:="386mm x 286mm x 297mm"
		...
		If (<>TbPAAssociation{$L}="LRAR-M") & (TbNumCampagne{$Salé}#"@A")
			  //Il ne fait rien, pas de proforma pour les poudre du groupement marocains
		Else 
