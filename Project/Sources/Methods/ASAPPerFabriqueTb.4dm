...
$Labo:=(ZAvantProc="@Labo")
If (Count parameters:C259=0)
	QUERY SELECTION:C341([Personnes:12]; [Personnes:12]Caduc:8=False:C215; *)
	$TypePersonne:=(Num:C11(ZAvantProc="@labo")*"laboratoire")+(Num:C11(ZAvantProc="@Adh")*"Individu")+(Num:C11(ZAvantProc="@tes")*"Testeur")+(Num:C11(ZAvantProc="@Partner")*"Partenaire")+(Num:C11(ZAvantProc="@Prospect")*"Prospect")
