...
For ($Salé; 1; $TT)  // Pour chaque destinataire ou pour chaque facture
	...
	If ($status.success)  // L'envoi a été effectué
		...
		//[PersonnesCourriels]UUIDPersonne:=[Personnes]UUID
		[PersonnesCourriels:31]UUIDPersonne:2:=TbMailPerUUID{$Salé}
...
VarTexteCRMail:="Envoi du mail "+<>ZGuil+VarObjetMail+<>ZGuil+" le "+String:C10(Current date:C33)+<>ZCR2+"Liste des destinataires :"
...
$email.to:="cegeheme@wanadoo.fr,asa-spv@wanadoo.fr,asa.eloise@gmail.com"
