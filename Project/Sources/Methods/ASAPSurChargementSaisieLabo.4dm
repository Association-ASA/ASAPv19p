...
ARRAY BOOLEAN:C223(TbMailLivraison; 0)
ARRAY TEXT:C222(TbMailsSansArobase; 0)
...
ASAPPerFabriqueTbMailsLabo("EmailRAEMA"; False:C215; True:C214; False:C215; False:C215)
ASAPPerFabriqueTbMailsLabo("EmailCompta"; False:C215; False:C215; True:C214; False:C215)
ASAPPerFabriqueTbMailsLabo("EmailLivraison"; False:C215; False:C215; False:C215; True:C214)
...
OBJECT SET VISIBLE:C603(*; "NumPersonne"; True:C214)
OBJECT SET VISIBLE:C603(*; "VarNumPersonne"; True:C214)
If (VarAssociation="Adilva@")
	OBJECT SET VISIBLE:C603(*; "NumPersonne"; False:C215)
	OBJECT SET VISIBLE:C603(*; "VarNumPersonne"; False:C215)
End if 
...
VarSiret:=OB Get:C1224([Personnes:12]Arguments:7; "NumSiretLabo"; Est un texte:K8:3)
VarNumEngagement:=OB Get:C1224([Personnes:12]Arguments:7; "NumEngagementCHORUS"; Est un texte:K8:3)
VarNumEngagementGel:=OB Get:C1224([Personnes:12]Arguments:7; "NumEngagementCHORUSGel"; Est un texte:K8:3)
VarNumService:=OB Get:C1224([Personnes:12]Arguments:7; "NumServiceCHORUS"; Est un texte:K8:3)
VarNumServiceGel:=OB Get:C1224([Personnes:12]Arguments:7; "NumServiceCHORUSGel"; Est un texte:K8:3)
CaCFactureMultiple:=Num:C11(OB Get:C1224([Personnes:12]Arguments:7; "PayeDeuxFois"; Est un texte:K8:3)="Vrai")
CaCChorus:=Num:C11(OB Get:C1224([Personnes:12]Arguments:7; "FactureDansChorus"; Est un texte:K8:3)="Vrai")
CaCChorusGel:=Num:C11(OB Get:C1224([Personnes:12]Arguments:7; "FactureDansChorusGel"; Est un texte:K8:3)="Vrai")
CaCFacSerRendu:=Num:C11(OB Get:C1224([Personnes:12]Arguments:7; "FactureServiceRendu"; Est un texte:K8:3)="Vrai")
CaCFacCourrier:=Num:C11(OB Get:C1224([Personnes:12]Arguments:7; "FactureParCourrier"; Est un texte:K8:3)="Vrai")
$CodeFacturation:=OB Get:C1224([Personnes:12]Arguments:7; "CodeFacturation"; Est un texte:K8:3)

CaCOutreMer:=Num:C11(OB Get:C1224([Personnes:12]Arguments:7; "FacturationPays"; Est un texte:K8:3)="Outre Mer")
...
SELECTION TO ARRAY:C260([Ventes:16]NumFacture:2; TbNumFacture; [Ventes:16]DateVente:4; TbDateVente; [Ventes:16]DateReglement:12; TbDateF; [Ventes:16]Intitule:3; TbIntituleF; [Ventes:16]PrixTotalHT:7; TbPrixF)
...
SORT ARRAY:C229(TbDateVente; TbNumFacture; TbDateF; TbIntituleF; TbPrixF; TbNumEnrF; TbPayeF; <)
...
For ($Salé; 1; $FT)
	...
	Case of 
		: (TbNumFacture{$Salé}="@A") | (TbNumFacture{$Salé}="@D") | ($L>0)
			TbPayeF{$Salé}:="NC"
