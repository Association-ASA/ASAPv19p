...
APPEND TO ARRAY:C911(<>TbPtPersonnes; -><>TbPerAdrFacAd4)
...
APPEND TO ARRAY:C911(<>TbPtPersonnes; -><>TbPerAdrPerAd4)
ARRAY TEXT:C222(<>TbPerAdrPerPays; 0)
...
APPEND TO ARRAY:C911(<>TbPtPersonnes; -><>TbPerAdrProAd4)
ARRAY TEXT:C222(<>TbPerAdrProPays; 0)
...
APPEND TO ARRAY:C911(<>TbPtPersonnes; -><>TbPerAdrLivAd4)
ARRAY TEXT:C222(<>TbPerAdrLivPays; 0)
...
// TABLEAU TEXTE(<>PUMPerProprio;0)
//AJOUTER À TABLEAU(<>TbPtPersonnes;-><>PUMPerProprio)
