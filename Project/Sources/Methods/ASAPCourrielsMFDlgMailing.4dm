...
Case of 
	...
	: ($evt=Sur chargement:K2:1)
		...
		If (MailAdherent=False:C215)
			...
			SELECTION TO ARRAY:C260([Factures:15]NumFacture:3;TbNumFacMail\
				;[Factures:15]UUIDPersonne:2;TbUUIDFacMail\
				;[Factures:15]TotalTTC:10;TbTTCFacMail\
				;[Factures:15]AdresseFacturation:5;TbAdrFacMail\
				;[Factures:15]DateFacture:4;TbDateFacMail)
		Else 
