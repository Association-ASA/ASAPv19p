...
$Chemin:="Images/Buttons/EnvoiColis.png"
$CDImage:=Get 4D folder:C485(Dossier Resources courant:K5:16)+Replace string:C233($Chemin;"/";Séparateur dossier:K24:12)
$MethodesLapîn:="Imprimer les proforma:ASAPLaboImprimeProforma;Créer PDF proforma sur serveur:ASAPLaboExcServeurPdfProforma;Export RAEMA Gel:ASAPExportRAEMAGel"



OB SET:C1220($ObParam\
;"Champ significatif";->[CampagneParticipations:17]UUIDPersonne:2\
;"Champ clefs";->[CampagneParticipations:17]TexteParticipation:4\
;"Chemin logo";$CDImage\
;"Saisie";"Visu"\
;"Sortie";"Sortie"\
;"Fiche";"Fiche"\
