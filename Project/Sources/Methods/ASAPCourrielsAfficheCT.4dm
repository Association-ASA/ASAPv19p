...
End if 
SELECTION TO ARRAY:C260([CourrielsTypes:28]NomLettre:2;ZZonelettre;[CourrielsTypes:28]NumLettre:7;TbNumLettre)
LONGINT ARRAY FROM SELECTION:C647([CourrielsTypes:28];TbNumEnrLT)
SORT ARRAY:C229(TbNumLettre;ZZonelettre;TbNumEnrLT;>)
ZEntêteLettre:=""