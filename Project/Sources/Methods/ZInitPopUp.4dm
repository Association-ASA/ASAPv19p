...
// Date et heure : 20/01/21, 16:45:08
// ----------------------------------------------------
// Méthode : ZInitPopUp
// Description
// 
...
// Les transporteurs
ARRAY TEXT:C222(PUMTransporteur; 11)
...
ARRAY TEXT:C222(PUMMaiBoite; 3)
ARRAY TEXT:C222(PUMDecBoite; 3)
PUMMarsBoite{1}:="Aucune"
PUMMarsBoite{2}:="Gratuite"
PUMMarsBoite{3}:="Payante"
COPY ARRAY:C226(PUMMarsBoite; PUMOctobreBoite)
COPY ARRAY:C226(PUMMarsBoite; PUMMaiBoite)
COPY ARRAY:C226(PUMMarsBoite; PUMDecBoite)
