...
End if 
If ($Proforma="")
	$Proforma:=OB Get:C1224([Personnes:12]Arguments:7; "RGProforma"; Est un texte:K8:3)
End if 
If ($Proforma#"")
...
//VarNumBdCGel:=OB Lire([Personnes]Arguments;"RGNumBonCommande"+$AnCourantA;Est un texte)

// Le transporteur
//VarMaiTransport:=OB Lire([Personnes]Arguments;"RGTransporteur"+CampagneMai;Est un texte)
//VarDecembreTransport:=OB Lire([Personnes]Arguments;"RGTransporteur"+CampagneDécembre;Est un texte)
