...
// ----------------------------------------------------
// Méthode : ASAPPerPoudreModifCorresPot
// Description
//  Méthode qui gère la modification de la correspondance entre les pots
//   par un clic sur la boîte à cocher CaCMarsCP ou CaCOctobreCP
...
$NumCampagne:=$Pt->
$PtObjetCourant:=OBJECT Get pointer:C1124(Objet courant:K67:2)
$PtSP:=Get pointer:C304("CaC"+$Mois+"CP")  // La boîte à cocher des sans pathogène
$Valeur:=$PtSP->
...
For ($Salé; 1; $FT)
	If ($Valeur=1)
		OB SET:C1220([CampagneParticipations:17]Arguments:5; "CorrespondanceEntrePots"; True:C214)
	Else 
		OB REMOVE:C1226([CampagneParticipations:17]Arguments:5; "CorrespondanceEntrePots")
	End if 
