//%attributes = {}
  ...
  // ----------------------------------------------------
  // Méthode : ASAPPerPoudreModifNumSuiviDHL
  // Description
...
$CampagneCourante:=$Pt->
$PtNumSuiviDHL:=Get pointer:C304("Var"+$Mois+"NumSuiviDHL")
...
For ($Salé;1;$FT)
	...
	Else 
		OB SET:C1220([CampagneParticipations:17]Arguments:5;"NumSuiviDHL";$PtNumSuiviDHL->)
	End if 
