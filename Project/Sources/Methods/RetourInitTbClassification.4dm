...
If (Records in selection:C76([XData:1])=0)
	...
	PUMClassAdmi{41}:="A41-Retour sur abonnement"
	PUMClassAdmi{42}:="A42-Demande de devis RAEMA Poudre"
	PUMClassAdmi{43}:="A43-Retour sur réception échantillon"
	PUMClassAdmi{44}:="A44-Problème accès rapport suite impayé"
