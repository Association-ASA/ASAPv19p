...
If (OK=1)
	...
	For ($Salé; 1; $FT)
		...
		SELECTION TO ARRAY:C260([RAEMALignes:22]NomFr:4; $TbNomLigneF\
			; [RAEMALignes:22]UUID:1; $TbUUIDLigne\
			; [RAEMALignes:22]NomEn:5; $TbNomLigneA\
			; [RAEMALignes:22]Identifiant:3; $TbIdentifiantLigne)
		SORT ARRAY:C229($TbIdentifiantLigne; $TbNomLigneF; $TbNomLigneA; $TbUUIDLigne)
		...
		For ($Fumé; 1; $SFT)
			...
			QUERY:C277([RAEMAValeurs:23]; [RAEMAValeurs:23]UUIDLigne:2=$TbUUIDLigne{$Fumé})
