...
C_TEXT:C284($VarPortable;$VarTelPerso;$VarTelPro)
...
If (VarTelPro#$VarTelPro) | (VarTelPerso#$VarTelPerso) | (VarPortable#$VarPortable)
	OB SET:C1220([Personnes:12]Arguments:7;"PhonePro";VarTelPro)
	OB SET:C1220([Personnes:12]Arguments:7;"TelephonePerso";VarTelPerso)
	OB SET:C1220([Personnes:12]Arguments:7;"Portable";VarPortable)
End if 
