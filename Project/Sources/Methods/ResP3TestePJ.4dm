...
C_LONGINT:C283($TT;$NbCampagne;$Pos;$NbCampagneAvecNumEchPoudre)
...
If (<>NumCampagneEnCoursSaisie="@A")
	$NbCampagneAvecNumEchPoudre:=OB Get:C1224([RAEMACampagnes:20]Arguments:7;"NbreLignePJ";Est un entier long:K8:6)
	$NbCampagne:=$NbCampagneAvecNumEchPoudre-5
Else 
