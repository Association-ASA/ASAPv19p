...
QUERY:C277([CampagneParticipations:17];[CampagneParticipations:17]UUID:1=UUIDParticipation)
  ...
  //CRÉER ENREGISTREMENT([CampagneParticipations])
  //[CampagneParticipations]NumCampagne:=$NumCampagne
  //[CampagneParticipations]UUIDPersonne:=$UUID
  //OB FIXER([CampagneParticipations]Arguments;"Sauvage";Vrai)
