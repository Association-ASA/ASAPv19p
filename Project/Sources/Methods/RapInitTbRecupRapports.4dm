...
QUERY BY ATTRIBUTE:C1331([CampagneParticipations:17];  & ; [CampagneParticipations:17]Arguments:5; "RéponseEnvoyée"; #; Null:C1517)
...
Case of 
	...
	Else 
		...
		For ($Salé; 1; $FT)  // Pour chaque participation
			...
			$RapportPris:=OB Get:C1224($ArgumentCourant; "RapportPris"; Est un booléen:K8:9)
