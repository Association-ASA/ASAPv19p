...
If ($Intitulé="@xxx@")  // C'est un échantillon de RAEMA Gel
	...
	Else 
		$Intitulé:=Replace string:C233($Intitulé; $xxx; TbNumEchPrésent{$RangBCGel-1})
	End if 
End if 
...
// Le HTML
$THTML:=""
$Cachée:=Num:C11(Escamote & ($ClasstrPUM#""))*(" style="+<>ZGuil+"display: none;"+<>ZGuil)

$THTML:=$THTML+"           <tr class="+<>ZGuil+$ClasseLignePaireImpaire+" "+$ClasstrPUM+<>ZGuil+$Cachée+">"+<>ZCR
