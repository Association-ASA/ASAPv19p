		...
		If ($Critère#"") & ($ComparateurCourant#"") & ($ValeurCourante#"")
			...
			Else   // Ce n'est pas une propriété
				Case of 
					...
					: ($Critère="Chorus Poudre")  // recherche dans [Personnes] qui ont le critère PayeDeuxFois dans [Personnes]Arguments
						QUERY BY ATTRIBUTE:C1331([Personnes:12]; [Personnes:12]Arguments:7; "FactureDansChorus"; $Opérateur; "Vrai")
						If ($ValeurCourante="Faux")
							CREATE SET:C116([Personnes:12]; "$FactureDansChorus")
							ALL RECORDS:C47([Personnes:12])
							CREATE SET:C116([Personnes:12]; "$ToutPersonne")
							DIFFERENCE:C122("$ToutPersonne"; "$FactureDansChorus"; "$FactureDansChorusPoudre")
							USE SET:C118("$FactureDansChorusPoudre")
						End if 
						
					: ($Critère="Chorus Gel")  // recherche dans [Personnes] qui ont le critère PayeDeuxFois dans [Personnes]Arguments
						QUERY BY ATTRIBUTE:C1331([Personnes:12]; [Personnes:12]Arguments:7; "FactureDansChorusGel"; $Opérateur; "Vrai")
						If ($ValeurCourante="Faux")
							CREATE SET:C116([Personnes:12]; "FactureDansChorus")
							ALL RECORDS:C47([Personnes:12])
							CREATE SET:C116([Personnes:12]; "$ToutPersonne")
							DIFFERENCE:C122("$ToutPersonne"; "FactureDansChorus"; "FactureDansChorusGel")
							USE SET:C118("FactureDansChorusGel")
						End if 
						
					: ($Critère="Facture service rendu")  // recherche dans [Personnes] qui ont le critère PayeDeuxFois dans [Personnes]Arguments
						QUERY BY ATTRIBUTE:C1331([Personnes:12]; [Personnes:12]Arguments:7; "FactureServiceRendu"; $Opérateur; "Vrai")
						If ($ValeurCourante="Faux")
							CREATE SET:C116([Personnes:12]; "FactureServiceNonRendu")
							ALL RECORDS:C47([Personnes:12])
							CREATE SET:C116([Personnes:12]; "$ToutPersonne")
							DIFFERENCE:C122("$ToutPersonne"; "FactureServiceNonRendu"; "FactureServiceRendu")
							USE SET:C118("FactureServiceRendu")
						End if 
						
					: ($Critère="Envoi facture courrier")  // recherche dans [Personnes] qui ont le critère PayeDeuxFois dans [Personnes]Arguments
						QUERY BY ATTRIBUTE:C1331([Personnes:12]; [Personnes:12]Arguments:7; "FactureParCourrier"; $Opérateur; "Vrai")
						If ($ValeurCourante="Faux")
							CREATE SET:C116([Personnes:12]; "FactureNONParCourrier")
							ALL RECORDS:C47([Personnes:12])
							CREATE SET:C116([Personnes:12]; "$ToutPersonne")
							DIFFERENCE:C122("$ToutPersonne"; "FactureNONParCourrier"; "FactureParCourrier")
							USE SET:C118("FactureParCourrier")
						End if 
