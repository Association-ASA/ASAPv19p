...
If (OK=1) & ($CampagneACopier#"")
	...
	Else 
		...
		Else 
			QUERY:C277([RAEMAGermes:21]; [RAEMAGermes:21]Identifiant:3=$TestNouvelleCampagne; *)  // Rappel des [RAEMALignes]
			QUERY:C277([RAEMAGermes:21];  & [RAEMAGermes:21]Identifiant:3#($CampagneActuelle+"@A@"))  // Rappel des [RAEMALignes]
		End if 
		...
		Else 
			QUERY:C277([RAEMAGermes:21]; [RAEMAGermes:21]Identifiant:3=$TestNouvelleCampagne; *)  // Rappel des nouveaux germes créés
			QUERY:C277([RAEMAGermes:21];  & [RAEMAGermes:21]Identifiant:3#($CampagneActuelle+"@A@"))  // Rappel des nouveaux germes créés
		End if 
		...
		Else 
			QUERY:C277([RAEMALignes:22]; [RAEMALignes:22]Identifiant:3=$TestNouvelleCampagne; *)  // Rappel des nouvelles lignes créées
			QUERY:C277([RAEMALignes:22];  & [RAEMALignes:22]Identifiant:3#($CampagneActuelle+"@A@"))
		End if 
		...
		//OB FIXER([RAEMACampagnes]Arguments;"Rang";$Rang)
