...
[DiaTextesWebParagraphes:37]NiveauTitre:13:=$Niveau
...
Else   // pas de borne supérieure
	$RadicalN:=Num:C11(Substring:C12($OrdreA;1;$Niveau))+1
End if 
...
GOTO RECORD:C242([DiaTextesWebParagraphes:37];$ID)  // Remise sur la ligne d'origine
