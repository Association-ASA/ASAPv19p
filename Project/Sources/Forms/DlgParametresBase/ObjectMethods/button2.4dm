...
$togPtr:=->togObj2  //<-- Modify process variable here so they are unique, (ex: togObj->togObj1)

$fieldPtr:=-><>ZNews  //<-- Change to ptr of field
$container:="container2"  //<-- Change to name of container picture var
$val:="val2"  //<-- Change to name of value variable
//----------------------------------------------//
